...
while True:
    ...
    if lmList != []:
        ...
        txt = cv2.putText(img,text = "VASANI007",org = (10,90),fontFace = cv2.FONT_HERSHEY_COMPLEX,fontScale = 1,color = (0,0,255),thickness = 2,lineType = cv2.LINE_8,bottomLeftOrigin = False)
